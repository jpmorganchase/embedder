# Helper code taken from Amazon Braket examples under Apache License 2.0
# Reference: https://github.com/amazon-braket/amazon-braket-examples/blob/main/examples/analog_hamiltonian_simulation/ahs_utils.py
